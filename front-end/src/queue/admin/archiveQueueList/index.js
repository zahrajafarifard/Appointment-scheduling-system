...
import ArchiveQueueDetails from "./archiveQueueDetails";

const ArchiveQueueList = () => {
  ...
  useEffect(() => {
    fetch(`${process.env.REACT_APP_URL}/admin/getArchiveQueue`, {
      method: "GET",
      headers: {
    ...
    <div className="justify-center">
      ...
      <div className="">
        ...
        >
          ...
          <span className="ml-14 screen400:ml-6">وضعیت</span>
        </div>
      ...
      {reservedData?.map((queue) => {
        return (
          <ArchiveQueueDetails
            ...
            nationalCode={queue.nationalCode}
            nationalCard={queue.nationalCard}
            mobile={queue.mobile}
            startTime={queue.date}
...
export default ArchiveQueueList;
